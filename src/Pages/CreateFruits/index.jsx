...
const CreateFruits = () =>  {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if(!fruitData.name || !fruitData.color || !fruitData.age){
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                Age: <input type="number" name="age" value={fruitData.age} onChange={(e) => setFruitData({...fruitData, age: parseInt(e.target.value, 10)})} /><br/>
